...
points = np.load("NDDCT_case-20_points_V5.npy",allow_pickle=True)
data = np.load("NDDCT_case-20_data_V5.npy")-273.15
...
plt.savefig("NDDCT3",bbox_inches = 'tight',pad_inches = 0,dpi=300)
